...
import borges
from borges.utilities import decorators


@dataclasses.dataclass
class Analyst(amos.project.Worker):
    """Base class for primitive objects in a amos composite object.
    ...
    workflow: amos.project.Workflow = None
...
@dataclasses.dataclass
class Report(borges.base.TheorySummary):
