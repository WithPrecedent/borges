...
class Scale(amos.project.Step):
    ...
    """    
    name: str = 'scale'
    contents: amos.project.Technique = None
    parameters: Union[Mapping[str, Any], base.Parameters] = base.Parameters()
    parallel: ClassVar[bool] = True
    

@dataclasses.dataclass
class MinMaxScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
scalers = amos.Library()


@dataclasses.dataclass
class MaxAbsoluteScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class NormalizeScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class QuantileScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class RobustScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
@dataclasses.dataclass
class StandardScale(borges.components.SklearnTransformer):
    """Wrapper for a Technique.
...
# @dataclasses.dataclass
# class GaussScale(borges.components.SklearnTransformer):
