...
class Encode(amos.project.Step):
...
@dataclasses.dataclass
class CategoryEncoder(borges.quirks.SklearnTransformer, 
                      amos.project.Technique):
    ...
    def implement(self, project: base.Theory) -> base.Theory:
        ...
        """
        try:
            self.parameters = self.parameters.finalize(borges =project)
