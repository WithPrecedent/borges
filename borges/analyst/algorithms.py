...
class Gaussify(borges.core.TheoryAlgorithm):
...
class CompareCleaves(TechniqueOutline):
    ...
    def add(self, cleave_group, columns):
        """For the cleavers in borges, this step alows users to manually
    ...
    def _get_model_type(self, data: 'Dataset') -> str:
        ...
        Raises:
            TypeError: if 'label' attribute is neither None, 'boolean',
                'category', 'integer' or 'float' data type (using borges
                proxy datatypes).
