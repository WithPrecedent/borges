...
class Canvas(Book):
    ...
    Args:
        ...
        clerk (Optional[Union['Clerk', str]]): an instance of
            ...
            the borges package. Defaults to None.
    ...
    def _draft_options(self) -> None:
        self._options = TheoryRepository(contents = {
            'styler': ('borges.artist.steps.styler', 'Styler'),
            'painter': ('borges.artist.steps.paint', 'Painter'),
            'animator': ('borges.artist.steps.animator', 'Animator')}
        return self
