"""
borges: data science made simple
...
Contents:
    importables (dict[str, str]): dict of imports available directly from 
        'borges'. This dict is needed to lazily import' modules using the 
        '__getattr__' function of this module.  
        
borges uses amos's lazy import system so that subpackages, modules, and
...
the lazy importation system used throughout borges.
"""
