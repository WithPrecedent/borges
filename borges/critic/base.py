...
#             name = 'eli5_explain',
#             module = 'borges.critic.explainers',
...
#         'eli5': base.TheoryTechnique(
#             name = 'eli5_predict',
#             module = 'borges.critic.predictors',
...
#     'measure': {
#         'borges': base.TheoryTechnique(
#             name = 'borges_measure',
#             module = 'borges.critic.metrics',
#             algorithm = 'borgesMeasure'),
#         'sklearn': base.TheoryTechnique(
...
#         'borges': base.TheoryTechnique(
#             name = 'borges_report',
#             module = 'borges.critic.reporters',
#             algorithm = 'borgesReport'),
#         'sklearn': base.TheoryTechnique(
#             name = 'sklearn_report',
#             module = 'borges.critic.reporters',
...
class Anthology(Book):
    ...
    Args:
        name (Optional[str]): designates the name of the class used for internal
            referencing throughout borges. If the class needs settings from
            the shared 'Idea' instance, 'name' should match the appropriate
            section name in 'Idea'. When subclassing, it is a good idea to use
            the same 'name' attribute as the base class for effective
            coordination between borges classes. 'name' is used instead of
...
class Evaluator(Technique):
    ...
    Args:
        name (Optional[str]): designates the name of the class used for internal
            ...
            section name in 'Idea'. When subclassing, it is a good idea to use
            the same 'name' attribute as the base class for effective
            coord   ination between borges classes. 'name' is used instead of
            __class__.__name__ to make such subclassing easier. Defaults to
            None or __class__.__name__.lower() if super().__post_init__ is
            called.
        module (Optional[str]): name of module where object to use is located
            (can either be a borges or non-borges module). Defaults to
            'borges.core'.
...
class Critic(Worker):
    ...
    module: Optional[str] = dataclasses.field(
        default_factory = lambda: 'borges.critic.critic')
